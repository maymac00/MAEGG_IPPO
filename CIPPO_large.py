...
class LargeSizeCOptimize(OptimizerMAEGG):
    ...
    def pre_objective_callback(self, trial):
        ...
        self.args.const_limit_1 = trial.suggest_int("const_limit_1", 2, 6)
        self.args.const_limit_2 = trial.suggest_int("const_limit_2", 2, 6)
    ...
    def construct_ppo(self, trial):
        ...
        final_value = 0.4
        ppo.addCallbacks([
            PrintAverageReward(ppo, n=20, show_time=True),
...
if __name__ == "__main__":
    ...
    opt = LargeSizeCOptimize("maximize", large, args, n_trials=1, save=args.save_dir, study_name=args.tag)
    opt.optimize()
